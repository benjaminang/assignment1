                ...
                <div class="ui column row">
                    <div class="ui grid">
                        ...
                        <div class="ten wide column">
                            <div class="speech"><p/>
                                <h1>Text to be translated goes here</h1>
                            </div>
                        ...
                        <div class="ui grid">
                            ...
                            <div class="eight wide column">
                                ...
                                <form class="form-style-4" action="" method="post">
                                    <label for="field4">
                                        <span>Answer:</span><textarea name="field4" onkeyup="adjust_textarea(this)" required="true"></textarea>
                                        &nbsp;
                                        <button class="ui inverted green button">Submit</button>
                                        <button class="ui inverted blue button">Skip</button>
                                    </label>
